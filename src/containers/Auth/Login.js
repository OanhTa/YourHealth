...
class Login extends Component {
    ...
    render() {
        //JSX 
        return ( //chỉ return ra 1 khối - ex: <div></div>
                        ...
                        <div className='col-12 form-group login-input'>
                            ...
                            <div className='custom-input-pwd'>
                                ...
                                <span onClick={() => { this.handleShowhidePWD() }}>
                                    <i className={this.state.isshowPWD ? "far fa-eye" : "far fa-eye-slash"}></i></span>
...
const mapStateToProps = state => { {/**of redux */}
    return {
        language: state.app.language
    };
};

const mapDispatchToProps = dispatch => { {/**of redux */}
    return {
